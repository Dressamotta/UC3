...
"""
 Classe abstrata Animal → Define emitir_som() como um método abstrato, forçando as classes-filhas a implementá-lo.  
 ...
 Testes → Criamos objetos Cachorro e Gato e chamamos os métodos para verificar o funcionamento."""
...
repo.cadastrar({"nome": "Ana Souza", "email": "ana@email.com"})
repo.cadastrar({"nome": "Carlos Silva", "email": "carlos@email.com"})
repo.cadastrar({"nome": "Ana Souza", "email": "ana@email.com"})  # Testando email duplicado
...
print("\nBuscando usuário:")
print(repo.buscar_por_email("carlos@email.com"))

# Removendo usuário
print("\nRemovendo usuário:")
print(repo.remover("ana@email.com"))
print(repo.listar_todos())

# Atualizando usuário
print("\nAtualizando usuário:")
repo.atualizar({"nome": "Carlos Silva", "email": "carlos@email.com", "telefone": "9999-9999"})  # Adicionando telefone
print(repo.listar_todos())

# Listando por nome
print("\nListando usuários por nome:")
print(repo.listar_por_nome("Carlos Silva"))

# Listando por nome e email
print("\nListando usuários por nome e email:")
print(repo.listar_por_nome_e_email("Carlos Silva", "carlos@email.com"))
